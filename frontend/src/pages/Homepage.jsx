          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              ...
              {/* <div className="dropdown dropdown-end">
                ...
                <ul className="mt-3 p-2 shadow-lg menu menu-sm dropdown-content glass-dark rounded-box w-52 border border-gray-700">
                  <li>
                    <NavLink to="/dashboard" className="text-blue-400 hover:bg-blue-400/10">
                      <User className="w-4 h-4" />
                      Dashboard
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/favorites" className="text-yellow-400 hover:bg-yellow-400/10">
                      <Star className="w-4 h-4" />
                      My Lists
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/points" className="text-yellow-300 hover:bg-yellow-300/10">
                      <Star className="w-4 h-4" />
                      Points
                    </NavLink>
                  </li>
                  ...
                  <li>
                    <NavLink to="/premium" className="text-yellow-400 hover:bg-yellow-400/10">
                      <Crown className="w-4 h-4" />
                      {subscriptionStatus?.hasActiveSubscription ? 'Upgrade Premium' : 'Get Premium'}
                    </NavLink>
                  </li>
                  
                  <li>
                    <button onClick={handleLogout} className="text-red-400 hover:bg-red-400/10">
                      Logout
                    </button>
                  </li>
                  {user?.role === 'admin' && (
                    <li>
                      <NavLink to="/admin" className="text-blue-400 hover:bg-blue-400/10">
                        Admin Panel
                      </NavLink>
                    </li>
                  )}
